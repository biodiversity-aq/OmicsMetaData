...
For the purpose of this vignett, the dataset PRJNA305344 will be used as an example. Set up your environment as follows:
...
Alternatvely, we can also choose only to download the metadata like this:
